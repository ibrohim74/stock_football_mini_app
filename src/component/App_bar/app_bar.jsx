    ...
    return (
        <div className="app_bar">
            <div className="app_bar_content">
                <Link to={`/${user_id}`} className={`app_bar_content_item ${location.pathname === `/${user_id}` ? 'active' : ''}`} ref={boshSahifaRef}>
                ...
                <Link to={`/${user_id}/Events_Page`} className={`app_bar_content_item ${location.pathname === `/${user_id}/Events_Page` ? 'active' : ''}`} ref={eventsRef}>
                    <img src={event} alt="Events" loading="lazy" />
                    <p>{t("app_bar.vazifalar")}</p>
                </Link>

                <div className="app_bar_live">
                    <Link to={`/${user_id}/peredacha`} className={`app_live_button ${location.pathname === `/${user_id}/peredacha` ? 'active' : ''}`} ref={peredachaRef}>
                        {t("app_bar.live")}
                    </Link>
                </div>

                <Link to={`/${user_id}/friends`} className={`app_bar_content_item ${location.pathname === `/${user_id}/friends` ? 'active' : ''}`} ref={friendsRef}>
                    <img src={users} alt="Friends" loading="lazy" />
                    <p>{t("app_bar.dostlar")}</p>
                </Link>

                <Link to={`/${user_id}/rating`} className={`app_bar_content_item ${location.pathname === `/${user_id}/rating` ? 'active' : ''}`} ref={ratingRef}>
